...
output_path="$root_dir/public/assets/og-card.png"

mkdir -p "$root_dir/public/assets"

convert -size 1200x630 xc:'#080d14' \
  -fill '#0d141e' -draw 'roundrectangle 54,54 1146,576 28,28' \
  -fill '#ff7a1a' -draw 'roundrectangle 54,54 68,576 7,7' \
  -fill '#151f2c' -draw 'circle 973,315 973,182' \
  ...
  -fill '#9eabb9' -font DejaVu-Sans -pointsize 18 -gravity southwest -annotate +108+88 'mike-elio.github.io' \
